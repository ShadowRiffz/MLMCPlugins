			...
			if (args.length == 0) {
				...
				// /prof level playername
					...
					if (args[1].equalsIgnoreCase("essence")) {
						...
						p.getInventory().addItem(AugmentManager.augmentMap.get(args[2]).createNew(Integer.parseInt(args[3])).getItem(p));
					}
					...
					if (args[1].equalsIgnoreCase("get")) {
						if (args[2].equalsIgnoreCase("essence")) {
							...
							p.getInventory().addItem(AugmentManager.augmentMap.get(args[3]).createNew(Integer.parseInt(args[4])).getItem(p));
						}
