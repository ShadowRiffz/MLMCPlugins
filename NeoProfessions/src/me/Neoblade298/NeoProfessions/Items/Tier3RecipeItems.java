...
public class Tier3RecipeItems {
	...
	public ItemStack getGardenSalad() {
		...
		lore.add("§7Effects: §9+40 INT (180s)");
	...
	public ItemStack getChickenLeg() {
		...
		lore.add("§7Effects: §aSlowness II (20s)");
		lore.add("§7Hunger: §e5.5 Food Bars");
		lore.add("§7Restores §c480 HP (120/5s)§7, §b0 MP");
	...
	public ItemStack getApplePorkchops() {
		...
		lore.add("§7Effects: §9+145 INT (10s)§7,§9 +145 SPR (10s)");
	...
	public ItemStack getScrambledEggs() {
		...
		lore.add("§7Effects: §9+120 STR (10s)");
		lore.add("§7Hunger: §e5 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
	...
	public ItemStack getLambKabob() {
		...
		lore.add("§7Effects: §9+30 STR (150s)§7, §9+30 DEX (150s)");
	...
	public ItemStack getZestySteak() {
		...
		lore.add("§7Hunger: §e6.5 Food Bars");
		lore.add("§7Restores §c1200 HP (50/5s)§7, §b0 MP");
		lore.add("§7Cooldown: §6300 Seconds");
		meta.setLore(lore);
		item.setItemMeta(meta);
		return item;
	...
	public ItemStack getLoadedBakedPotato() {
		...
		lore.add("§7Effects: §9+85 END (180s)");
	...
	public ItemStack getSweetBuns() {
		...
		lore.add("§7Effects: §aSpeed III (10s)");
		lore.add("§7Hunger: §e6 Food Bars");
		lore.add("§7Restores §c200 HP§7, §b40 MP");
	...
	public ItemStack getSpaghettiBolognese() {
		...
		lore.add("§7Restores §c0 HP§7, §b360 MP (12/5s)");
		lore.add("§7Cooldown: §6300 Seconds");
		meta.setLore(lore);
		item.setItemMeta(meta);
		return item;
	...
	public ItemStack getFilletedSalmon() {
		...
		lore.add("§7Effects: §9+40 DEX (180s)");
		lore.add("§7Hunger: §e5 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
		lore.add("§7Cooldown: §6300 Seconds");
		meta.setLore(lore);
	...
	public ItemStack getRoastBream() {
		...
		lore.add("§7Effects: §9+45 SPR (150s)");
		lore.add("§7Hunger: §e5 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
		lore.add("§7Cooldown: §6240 Seconds");
		meta.setLore(lore);
	...
	public ItemStack getSmoothie() {
		...
		lore.add("§7Effects: §aSpeed III (5s)");
	...
	public ItemStack getHeartyBurrito() {
		...
		lore.add("§7Effects: §9+100 STR (20s)");
		lore.add("§7Hunger: §e6.5 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
		lore.add("§7Cooldown: §690 Seconds");
		meta.setLore(lore);
	...
	public ItemStack getHeroSandwich() {
		...
		lore.add("§7Effects: §fNone");
		lore.add("§7Hunger: §e7 Food Bars");
		lore.add("§7Restores §c1440 HP (120/10s)§7, §b0 MP");
	...
	public ItemStack getLambStew() {
		...
		lore.add("§7Effects: §9+130 DEX (10s)");
		lore.add("§7Hunger: §e6 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
		lore.add("§7Cooldown: §6120 Seconds");
		meta.setLore(lore);
	...
	public ItemStack getHoneyGlazedChicken() {
		...
		lore.add("§7Effects: §fNone");
		lore.add("§7Hunger: §e8 Food Bars");
		lore.add("§7Restores §c960 HP (40/5s)§7, §b144 MP (6/5s)");
		lore.add("§7Cooldown: §6360 Seconds");
		meta.setLore(lore);
		item.setItemMeta(meta);
		return item;
	...
	public ItemStack getAppleCider() {
		...
		lore.add("§7Effects: §fNone");
		lore.add("§7Hunger: §e5.5 Food Bars");
		lore.add("§7Restores §c100 HP§7, §b125 MP");
		lore.add("§7Cooldown: §660 Seconds");
		meta.setLore(lore);
		item.setItemMeta(meta);
		return item;
	...
	public ItemStack getMushroomPasty() {
		...
		lore.add("§7Effects: §9+90 STR (15s)§7, §9+90 DEX (15s)§7,");
		lore.add("§9+90 INT (15s)§7, §9+90 SPR (15s)");
		lore.add("§7Hunger: §e7 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
	...
	public ItemStack getSpongeCake() {
		...
		lore.add("§7Effects: §9+20 STR (240s)§7, §9+20 DEX (240s)§7,");
		lore.add("§9+20 INT (240s)§7, §9+20 SPR (240s)");
		lore.add("§7Hunger: §e4.5 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
	...
	public ItemStack getChickenParmesan() {
		...
		lore.add("§7Effects: §9+300 VIT (240s)§7, §9+30 END (240s)");
		lore.add("§7Hunger: §e5 Food Bars");
		lore.add("§7Restores §c0 HP§7, §b0 MP");
		lore.add("§7Cooldown: §6480 Seconds");
		meta.setLore(lore);
